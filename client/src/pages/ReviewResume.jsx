...
const ReviewResume = () => {
  ...
  return show ?(
    <div className="h-full flex items-center justify-center "> <p>This Feature is not Available yet. This will  be coming soon.</p></div>
  ):(
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4  text-slate-700">
      ...
      >
        ...
        <input
          ...
          required
        />
        <p className="text-sm text-gray-50 font-light mt-1">
